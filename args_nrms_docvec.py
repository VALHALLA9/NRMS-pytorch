...
def get_args():
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default=str("E:\\desktop\\test\\Dataset"),
    ...
    parser.add_argument(
        "--datasplit", type=str, default="ebnerd_demo", help="Dataset split to use"
    )
    ...
    # Chunk processing
    parser.add_argument(
        "--n_chunks_test", type=int, default=1, help="Number of test chunks to process"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--document_embeddings",
        type=str,
        default="E:\\desktop\\test\\Dataset\\contrastive_vector.parquet",
